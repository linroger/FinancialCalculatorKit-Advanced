...
extension Color {
    // MARK: - Dynamic Colors with Dark Mode Support
    
    /// Financial green - adapts to light/dark mode
    static let financialGreen = Color(
        light: Color(red: 0.16, green: 0.69, blue: 0.27),
        dark: Color(red: 0.20, green: 0.78, blue: 0.35)
    )
    
    /// Financial red - adapts to light/dark mode
    static let financialRed = Color(
        light: Color(red: 0.85, green: 0.24, blue: 0.24),
        dark: Color(red: 0.90, green: 0.35, blue: 0.35)
    )
    
    /// Financial blue - adapts to light/dark mode
    static let financialBlue = Color(
        light: Color(red: 0.20, green: 0.54, blue: 0.84),
        dark: Color(red: 0.30, green: 0.64, blue: 0.94)
    )
    
    /// Financial orange - adapts to light/dark mode
    static let financialOrange = Color(
        light: Color(red: 0.95, green: 0.61, blue: 0.07),
        dark: Color(red: 1.0, green: 0.70, blue: 0.20)
    )
    
    /// Financial purple - adapts to light/dark mode
    static let financialPurple = Color(
        light: Color(red: 0.58, green: 0.32, blue: 0.82),
        dark: Color(red: 0.68, green: 0.42, blue: 0.92)
    )
    
    /// Financial teal - adapts to light/dark mode
    static let financialTeal = Color(
        light: Color(red: 0.18, green: 0.71, blue: 0.66),
        dark: Color(red: 0.25, green: 0.81, blue: 0.76)
    )
    
    // MARK: - Semantic Colors for Financial Contexts
    
    /// Profit/positive indicator - higher contrast in dark mode
    static let profitGreen = Color(
        light: Color(red: 0.13, green: 0.59, blue: 0.24),
        dark: Color(red: 0.20, green: 0.75, blue: 0.35)
    )
    
    /// Loss/negative indicator - higher contrast in dark mode
    static let lossRed = Color(
        light: Color(red: 0.79, green: 0.15, blue: 0.15),
        dark: Color(red: 0.90, green: 0.30, blue: 0.30)
    )
    
    /// Neutral/unchanged indicator
    static let neutralGray = Color(
    ...
    /// Card background - uses system colors for proper adaptation
    static let cardBackground = Color(NSColor.controlBackgroundColor)
    
    /// Section background - slightly darker than card background
    static let sectionBackground = Color(NSColor.windowBackgroundColor)
    
    // MARK: - Helper initializer for light/dark mode support
