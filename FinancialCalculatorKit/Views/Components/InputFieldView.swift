...
struct InputFieldView: View {
    ...
    private var inputModifier: some ViewModifier {
        switch keyboardType {
        case .decimalPad:
            return AnyViewModifier(NumbersOnlyViewModifier(
                text: $value,
                inputType: .decimal,
                maxDecimalPlaces: 6,
                allowsNegative: true
...
/// Type-erased view modifier for conditional application
...
/// Empty modifier for when no modification is needed
