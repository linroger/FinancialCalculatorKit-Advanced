...
struct AdvancedDerivativesAnalyticsView: View {
    ...
    var body: some View {
        GeometryReader { geometry in
            if geometry.size.width > 1200 {
                ...
                NavigationSplitView {
                    sidebarContent
                        .frame(minWidth: 400, idealWidth: min(450, geometry.size.width * 0.3))
                } content: {
                    analysisContent
                        .frame(minWidth: 600)
                } detail: {
                ...
                NavigationSplitView {
                    sidebarContent
                        .frame(minWidth: 350, idealWidth: min(400, geometry.size.width * 0.4))
                } detail: {
                    ScrollView {
                        VStack(spacing: 24) {
        ...
        .responsiveFrame(minWidth: 1000, idealWidth: 1600, minHeight: 800, idealHeight: 1000)
        .toolbar {
            toolbarContent
        }
        .onAppear {
    ...
    @ViewBuilder
    private var analysisContentCompact: some View {
        VStack(spacing: 20) {
            switch analysisType {
            case .pricing:
                pricingAnalysisView
    ...
    @ViewBuilder
    private var detailContentCompact: some View {
        VStack(spacing: 20) {
