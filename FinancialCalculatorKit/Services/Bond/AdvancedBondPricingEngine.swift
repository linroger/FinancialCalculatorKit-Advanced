...
class AdvancedBondPricingEngine: ObservableObject {
    ...
    /// Enable high-precision calculations for bond pricing
    public var enableHighPrecision: Bool = false
    
    /// Precision mode for decimal calculations
    public var precisionMode: HighPrecisionMath.PrecisionMode = .high
    ...
    private func calculateBasicBondMetrics(
        ...
        var convexity = 0.0
        // var cashFlows: [(period: Int, amount: Double, pv: Double)] = []  // For future cash flow analysis
        ...
        case .fixed:
            (price, macaulayDuration, convexity, _) = calculateFixedRateBond(
                faceValue: faceValue,
