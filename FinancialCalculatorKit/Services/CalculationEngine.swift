...
class CalculationEngine {
    ...
    static func calculateAdvancedIRR(
        cashFlows: [Double],
        config: AdvancedIRRCalculator.CalculationConfig = .standard
...
extension CalculationEngine {
    ...
    static func calculatePresentValueWithPrecision(
        futureValue: Double? = nil,
        payment: Double? = nil,
        interestRate: Double,
        numberOfPeriods: Double,
    ...
    static func calculateFutureValueWithPrecision(
        presentValue: Double? = nil,
        payment: Double? = nil,
        interestRate: Double,
        numberOfPeriods: Double,
    ...
    static func calculateNPVWithPrecision(
        cashFlows: [Double],
        discountRate: Double,
        usePrecision: Bool? = nil
    ) -> Double {
    ...
    static func calculateIRRWithPrecision(
        cashFlows: [Double],
        usePrecision: Bool? = nil
    ) -> Double {
        let useHighPrecision = usePrecision ?? enableHighPrecision
    ...
    static func calculateBondPriceWithPrecision(
        faceValue: Double,
        couponRate: Double,
        marketRate: Double,
        yearsToMaturity: Double,
    ...
    static func calculateBarrierOptionPrice(
        spotPrice: Double,
        strikePrice: Double,
        barrierLevel: Double,
        timeToExpiry: Double,
    ...
    static func calculatePortfolioVaR(
        portfolioValue: Double,
        returns: [Double],
        confidenceLevel: Double = 0.95,
        timeHorizon: Int = 1
    ...
    static func calculateOptimalPortfolioWeights(
    ...
    static func calculateRealEstateInvestment(
    ...
    static func calculateCryptoDCAStrategy(
    ...
    static func calculateCurrencyHedging(
    ...
    private static func generateStandardNormal() -> Double {
