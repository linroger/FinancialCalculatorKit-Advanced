...
public struct CalculationResult: Codable, Sendable {
...
public struct ChartDataPoint: Identifiable, Codable, Sendable {
    public let id = UUID()
    public let x: Double
    public let y: Double
...
/// Row data for tables
public struct TableRow: Identifiable, Codable, Sendable {
    public let id = UUID()
