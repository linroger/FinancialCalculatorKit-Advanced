---
url: "https://developer.apple.com/design/human-interface-guidelines/entering-data?changes=_5"
title: "Entering data | Apple Developer Documentation"
---

[Skip Navigation](https://developer.apple.com/design/human-interface-guidelines/entering-data?changes=_5#app-main)
...
## [Best practices](https://developer.apple.com/design/human-interface-guidelines/entering-data?changes=_5\#Best-practices)
...
**Use a secure text-entry field when appropriate.** If your app or game needs sensitive data, use a field that obscures people’s input as they enter it, typically by displaying a small filled circle symbol for each character. For developer guidance, see [`SecureField`](https://developer.apple.com/documentation/SwiftUI/SecureField?changes=_5). In tvOS, you can also configure a [digit entry view](https://developer.apple.com/design/human-interface-guidelines/digit-entry-views) to obscure the numerals people enter (for developer guidance, see [`isSecureDigitEntry`](https://developer.apple.com/documentation/TVUIKit/TVDigitEntryViewController/isSecureDigitEntry?changes=_5)). When you use the system-provided text field in visionOS, the system shows the entered data to the wearer, but not to anyone else; for example, a secure text field automatically blurs when people use AirPlay to stream their content.

**Never prepopulate a password field.** Always ask people to enter their password or use biometric or keychain authentication. For guidance, see [Managing accounts](https://developer.apple.com/design/human-interface-guidelines/managing-accounts?changes=_5).
...
## [Platform considerations](https://developer.apple.com/design/human-interface-guidelines/entering-data?changes=_5\#Platform-considerations)

_No additional considerations for iOS, iPadOS, tvOS, visionOS, or watchOS._

### [macOS](https://developer.apple.com/design/human-interface-guidelines/entering-data?changes=_5\#macOS)
...
## [Resources](https://developer.apple.com/design/human-interface-guidelines/entering-data?changes=_5\#Resources)

#### [Related](https://developer.apple.com/design/human-interface-guidelines/entering-data?changes=_5\#Related)

[Text fields](https://developer.apple.com/design/human-interface-guidelines/text-fields?changes=_5)

[Virtual keyboards](https://developer.apple.com/design/human-interface-guidelines/virtual-keyboards?changes=_5)

[Keyboards](https://developer.apple.com/design/human-interface-guidelines/keyboards?changes=_5)

#### [Developer documentation](https://developer.apple.com/design/human-interface-guidelines/entering-data?changes=_5\#Developer-documentation)

[Input events](https://developer.apple.com/documentation/SwiftUI/Input-events?changes=_5) — SwiftUI

#### [Videos](https://developer.apple.com/design/human-interface-guidelines/entering-data?changes=_5\#Videos)
...
## [Change log](https://developer.apple.com/design/human-interface-guidelines/entering-data?changes=_5\#Change-log)
...
- [Entering data](https://developer.apple.com/design/human-interface-guidelines/entering-data?changes=_5#app-top)
- [Best practices](https://developer.apple.com/design/human-interface-guidelines/entering-data?changes=_5#Best-practices)
- [Platform considerations](https://developer.apple.com/design/human-interface-guidelines/entering-data?changes=_5#Platform-considerations)
- [Resources](https://developer.apple.com/design/human-interface-guidelines/entering-data?changes=_5#Resources)
- [Change log](https://developer.apple.com/design/human-interface-guidelines/entering-data?changes=_5#Change-log)