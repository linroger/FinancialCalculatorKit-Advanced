...
[Skip Navigation](https://developer.apple.com/design/human-interface-guidelines/apple-pay#app-main)
...
For developer guidance, see [Apple Pay](https://developer.apple.com/documentation/PassKit/apple-pay).
...
**If you use Apple Pay APIs to find out whether someone has an active card in Wallet, you must make Apple Pay the primary — but not necessarily sole — payment option everywhere you use the APIs.** For example, you might pre-select Apple Pay as the payment option when you display it alongside other options. For developer guidance, see [`PKPaymentAuthorizationController`](https://developer.apple.com/documentation/PassKit/PKPaymentAuthorizationController) (iOS, watchOS) and [Checking for Apple Pay availability](https://developer.apple.com/documentation/ApplePayontheWeb/checking-for-apple-pay-availability) (web).
...
[![](https://devimages-cdn.apple.com/wwdc-services/images/3055294D-836B-4513-B7B0-0BC5666246B0/FC715972-F367-4C86-A291-5C0358E5E230/9873_wide_250x141_3x.jpg)\\
\\
...
- [Apple Pay](https://developer.apple.com/design/human-interface-guidelines/apple-pay#app-top)
- [Offering Apple Pay](https://developer.apple.com/design/human-interface-guidelines/apple-pay#Offering-Apple-Pay)
- [Streamlining checkout](https://developer.apple.com/design/human-interface-guidelines/apple-pay#Streamlining-checkout)
- [Handling errors](https://developer.apple.com/design/human-interface-guidelines/apple-pay#Handling-errors)
- [Supporting subscriptions](https://developer.apple.com/design/human-interface-guidelines/apple-pay#Supporting-subscriptions)
