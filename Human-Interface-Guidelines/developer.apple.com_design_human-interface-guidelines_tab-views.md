...
[Skip Navigation](https://developer.apple.com/design/human-interface-guidelines/tab-views#app-main)
...
![An illustration of a window in which a three-tab tabbed control is centered on the top edge of the content view.](https://docs-assets.developer.apple.com/published/4af8140a86ab3a690916d13177ac70f6/tab-views-top%402x.png)Top tabs

![An illustration of a window in which a three-tab tabbed control is centered on the bottom edge of the content view.](https://docs-assets.developer.apple.com/published/39d18dd1ca0c4ecdee0fb4e39bfb6193/tab-views-bottom%402x.png)Bottom tabs
...
- [Tab views](https://developer.apple.com/design/human-interface-guidelines/tab-views#app-top)
- [Best practices](https://developer.apple.com/design/human-interface-guidelines/tab-views#Best-practices)
- [Anatomy](https://developer.apple.com/design/human-interface-guidelines/tab-views#Anatomy)
- [Platform considerations](https://developer.apple.com/design/human-interface-guidelines/tab-views#Platform-considerations)
- [Resources](https://developer.apple.com/design/human-interface-guidelines/tab-views#Resources)
