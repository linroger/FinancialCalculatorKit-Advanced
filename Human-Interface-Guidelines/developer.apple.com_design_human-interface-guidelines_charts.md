...
[Skip Navigation](https://developer.apple.com/design/human-interface-guidelines/charts#app-main)
...
![A bar chart with callouts that identify chart components, such as axes, grid lines, marks, ticks, axis value labels, and the overall plot area.](https://docs-assets.developer.apple.com/published/6cb25f42f3d517bfac909faa4683e9ec/charts-anatomy%402x.png)
...
![A bar chart that depicts the number of steps for each day in a month.](https://docs-assets.developer.apple.com/published/50161ad20411f0d28f7de00c94bc7e91/bar-marks%402x.png)
...
![A line chart that depicts the performance of a stock over a five-year period.](https://docs-assets.developer.apple.com/published/e4f8e3cbc7decd88c7336e2947ef45ba/line-marks%402x.png)
...
![A point-mark chart that depicts per-day readings of heartbeats per minute over a 5 1/2-month period.](https://docs-assets.developer.apple.com/published/ce2e9986e140ea94700f188cce6c773f/point-marks%402x.png)
...
![A partial screenshot of Battery Settings on iPhone, which uses a chart to depict battery charge over time, where the charge can vary within a fixed range from 0% to 100%.](https://docs-assets.developer.apple.com/published/6b8fbf83fbad897aaaa55967ec3f66b3/fixed-range-axis%402x.png)
...
![A screenshot of the Steps chart in the Health app on iPhone, which shows the total number of steps for a single day.](https://docs-assets.developer.apple.com/published/be7b88a567c6e793dd58a510fb42b5f4/dynamic-range-axis-small%402x.png)

![A screenshot of the Steps chart in the Health app on iPhone, which shows the average number of steps per day in a one-month period.](https://docs-assets.developer.apple.com/published/c7019380e638f896bd3f5632f5ae7e79/dynamic-range-axis-large%402x.png)
...
![A partial screenshot of the Weather app on iPhone, which uses succinct, plain language to describe the precipitation forecasted for the next 60 minutes.](https://docs-assets.developer.apple.com/published/7ab15e42df1a3dbfffa6427773fa26cc/descriptive-content%402x.png)
...
![A partial screenshot of the Health app on iPhone showing a blood pressure chart that uses a red circle to represent systolic values and a black diamond to represent diastolic values.](https://docs-assets.developer.apple.com/published/756ade4516fa5fafcffbb1c49c77a462/chart-colors%402x.png)
...
[![](https://devimages-cdn.apple.com/wwdc-services/images/3055294D-836B-4513-B7B0-0BC5666246B0/89D5888B-58DA-4F47-8E3C-998253F6BA98/9954_wide_250x141_3x.jpg)\\
\\
Bring Swift Charts to the third dimension](https://developer.apple.com/videos/play/wwdc2025/313)

[![](https://devimages-cdn.apple.com/wwdc-services/images/124/FA764D2D-4E15-4E91-91BA-BDAC80FB901B/6694_wide_250x141_3x.jpg)\\
\\
Design app experiences with charts](https://developer.apple.com/videos/play/wwdc2022/110342)

[![](https://devimages-cdn.apple.com/wwdc-services/images/124/4BBCB61E-65ED-43FE-8F7B-81524E0C96BE/6692_wide_250x141_3x.jpg)\\
\\
...
- [Charts](https://developer.apple.com/design/human-interface-guidelines/charts#app-top)
- [Anatomy](https://developer.apple.com/design/human-interface-guidelines/charts#Anatomy)
- [Marks](https://developer.apple.com/design/human-interface-guidelines/charts#Marks)
- [Axes](https://developer.apple.com/design/human-interface-guidelines/charts#Axes)
- [Descriptive content](https://developer.apple.com/design/human-interface-guidelines/charts#Descriptive-content)
