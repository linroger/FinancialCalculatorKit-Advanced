...
[Skip Navigation](https://developer.apple.com/design/human-interface-guidelines/the-menu-bar#app-main)
...
![An illustration of an app window on iPad, with its menu bar appearing at the top of the screen and the Edit menu open.](https://docs-assets.developer.apple.com/published/4ffd4f0ec1b7088a7c3da9083d02bcdf/menu-bar-ipad-overview%402x.png)
...
![An illustration of an Edit menu that includes several similar Copy actions, with each represented by a different symbol.](https://docs-assets.developer.apple.com/published/7deb98def27f19a33794b9ec6cee02b4/menu-bar-copy-actions-different-icons-incorrect%402x.png)

![An X in a circle to indicate incorrect usage.](https://docs-assets.developer.apple.com/published/209f6f0fc8ad99d9bf59e12d82d06584/crossout%402x.png)

![An illustration of an Edit menu that includes several similar Copy actions, with each represented by the same Copy symbol.](https://docs-assets.developer.apple.com/published/60241bb399a7e5faa06e9e53de4d858b/menu-bar-copy-actions-repeated-icons-incorrect%402x.png)

![An X in a circle to indicate incorrect usage.](https://docs-assets.developer.apple.com/published/209f6f0fc8ad99d9bf59e12d82d06584/crossout%402x.png)

![An illustration of an Edit menu that includes several similar Copy actions. The first is represented by the Copy symbol, and the others with no symbol.](https://docs-assets.developer.apple.com/published/ee3e63278a8b0b023e35e963077f2596/menu-bar-copy-actions-single-icon-correct%402x.png)
...
![A screenshot of the Time Machine menu bar extra and its menu.](https://docs-assets.developer.apple.com/published/6241bbb0173be7b095716e2b46393f9b/menu-bar-extras%402x.png)
...
- [The menu bar](https://developer.apple.com/design/human-interface-guidelines/the-menu-bar#app-top)
- [Anatomy](https://developer.apple.com/design/human-interface-guidelines/the-menu-bar#Anatomy)
- [Best practices](https://developer.apple.com/design/human-interface-guidelines/the-menu-bar#Best-practices)
- [App menu](https://developer.apple.com/design/human-interface-guidelines/the-menu-bar#App-menu)
- [File menu](https://developer.apple.com/design/human-interface-guidelines/the-menu-bar#File-menu)
