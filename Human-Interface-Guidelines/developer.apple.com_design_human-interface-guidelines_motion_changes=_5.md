---
url: "https://developer.apple.com/design/human-interface-guidelines/motion?changes=_5"
title: "Motion | Apple Developer Documentation"
---

[Skip Navigation](https://developer.apple.com/design/human-interface-guidelines/motion?changes=_5#app-main)
...
## [Best practices](https://developer.apple.com/design/human-interface-guidelines/motion?changes=_5\#Best-practices)
...
## [Providing feedback](https://developer.apple.com/design/human-interface-guidelines/motion?changes=_5\#Providing-feedback)
...
**Consider using animated symbols where it makes sense.** When you use SF Symbols 5 or later, you can apply animations to SF Symbols or custom symbols. For guidance, see [Animations](https://developer.apple.com/design/human-interface-guidelines/sf-symbols?changes=_5#Animations).

## [Leveraging platform capabilities](https://developer.apple.com/design/human-interface-guidelines/motion?changes=_5\#Leveraging-platform-capabilities)
...
## [Platform considerations](https://developer.apple.com/design/human-interface-guidelines/motion?changes=_5\#Platform-considerations)

_No additional considerations for iOS, iPadOS, macOS, or tvOS._

### [visionOS](https://developer.apple.com/design/human-interface-guidelines/motion?changes=_5\#visionOS)

In addition to subtly communicating context, drawing attention to information, and enriching immersive experiences, motion in visionOS can combine with [depth](https://developer.apple.com/design/human-interface-guidelines/spatial-layout?changes=_5#Depth) to provide essential feedback when people look at interactive elements. Because motion is likely to be a large part of your visionOS experience, it’s crucial to avoid causing distraction, confusion, or discomfort.
...
**Help people remain comfortable when showing the movement of large virtual objects.** If an object is large enough to fill a lot of the [field of view](https://developer.apple.com/design/human-interface-guidelines/spatial-layout?changes=_5#Field-of-view), occluding most or all of [passthrough](https://developer.apple.com/design/human-interface-guidelines/immersive-experiences?changes=_5#Immersion-and-passthrough), people can naturally perceive it as being part of their surroundings. To help people perceive the object’s movement without making them think that they or their surroundings are moving, you can increase the object’s translucency, helping people see through it, or lower its contrast to make its motion less noticeable.
...
### [watchOS](https://developer.apple.com/design/human-interface-guidelines/motion?changes=_5\#watchOS)

SwiftUI provides a powerful and streamlined way to add motion to your app. If you need to use WatchKit to animate layout and appearance changes — or create animated image sequences — see [`WKInterfaceImage`](https://developer.apple.com/documentation/WatchKit/WKInterfaceImage?changes=_5).

## [Resources](https://developer.apple.com/design/human-interface-guidelines/motion?changes=_5\#Resources)

#### [Related](https://developer.apple.com/design/human-interface-guidelines/motion?changes=_5\#Related)
...
#### [Developer documentation](https://developer.apple.com/design/human-interface-guidelines/motion?changes=_5\#Developer-documentation)

[Animating views and transitions](https://developer.apple.com/tutorials/SwiftUI/animating-views-and-transitions?changes=_5) — SwiftUI

#### [Videos](https://developer.apple.com/design/human-interface-guidelines/motion?changes=_5\#Videos)

[![](https://devimages-cdn.apple.com/wwdc-services/images/C03E6E6D-A32A-41D0-9E50-C3C6059820AA/B38CC217-7635-48EF-B8C9-F7954F390CCE/9273_wide_250x141_3x.jpg)\\
\\
Enhance your UI animations and transitions](https://developer.apple.com/videos/play/wwdc2024/10145)

[![](https://devimages-cdn.apple.com/wwdc-services/images/C03E6E6D-A32A-41D0-9E50-C3C6059820AA/A8C0D750-CF09-48F3-982B-0D1B870F273F/9279_wide_250x141_3x.jpg)\\
\\
...
## [Change log](https://developer.apple.com/design/human-interface-guidelines/motion?changes=_5\#Change-log)
...
- [Motion](https://developer.apple.com/design/human-interface-guidelines/motion?changes=_5#app-top)
- [Best practices](https://developer.apple.com/design/human-interface-guidelines/motion?changes=_5#Best-practices)
- [Providing feedback](https://developer.apple.com/design/human-interface-guidelines/motion?changes=_5#Providing-feedback)
- [Leveraging platform capabilities](https://developer.apple.com/design/human-interface-guidelines/motion?changes=_5#Leveraging-platform-capabilities)
- [Platform considerations](https://developer.apple.com/design/human-interface-guidelines/motion?changes=_5#Platform-considerations)
