...
![An iPhone screenshot of the game The Coast, on the title screen. The access point control, a circular button with a diagonal rocket symbol, sits in the upper corner on the leading edge.](https://docs-assets.developer.apple.com/published/1aa312facfa3d22019c7a044d7451968/games-access-point-collapsed%402x.png)
...
![An iPhone screenshot of the game The Coast with the Game Overlay open, showing the Achievements overview screen.](https://docs-assets.developer.apple.com/published/75cab16268c33fc40a5a0b0d1cccb3c5/games-achievement-overlay%402x.png)

Achievements overview

![An iPhone screenshot of the game The Coast with the Game Overlay open, showing the detail view of a single achievement.](https://docs-assets.developer.apple.com/published/7a3586ff7d29771d363660e63a73759b/games-achievement-overlay-detail.png)
...
![An iPhone screenshot of the game The Coast with the Game Overlay open, showing the Leaderboards overview screen.](https://docs-assets.developer.apple.com/published/aed12a6a6e045c6b9217c3c7afd86a8d/games-leaderboards-overlay%402x.png)

Leaderboards overview

![An iPhone screenshot of the game The Coast with the Game Overlay open, showing the detail view of a single leaderboard.](https://docs-assets.developer.apple.com/published/2ff2051d93d08e4338e3f20639daf2ed/games-leaderboards-detail%402x.png)
...
![An iPhone screenshot of the game The Coast with the Game Overlay open, showing the Challenges overview screen.](https://docs-assets.developer.apple.com/published/e098a91057f7a004a1f59b18af58bc74/games-challenges-overlay%402x.png)

Challenges overview

![An iPhone screenshot of the game The Coast with the Game Overlay open, showing the detail view of a single challenge.](https://docs-assets.developer.apple.com/published/9028af4623f5ce0637a71cce8d1b098a/games-challenges-overlay-detail%402x.png)
...
![A diagram of a challenge card, with callouts indicating the challenge title, artwork, and number of players, and the system-provided gradient at the bottom of the card.](https://docs-assets.developer.apple.com/published/94931d3d87d2ad4a9a7054fdd1348d0c/games-challenge-anatomy%402x.png)
...
![An iPhone screenshot of the game The Coast with the Game Overlay open, showing the Multiplayer levels overview screen.](https://docs-assets.developer.apple.com/published/cd4bab2d208df73a1a588acd867f94ef/games-multiplayer-overlay%402x.png)

Multiplayer levels overview

![An iPhone screenshot of the game The Coast with the Game Overlay open, showing the detail view of a single multiplayer level.](https://docs-assets.developer.apple.com/published/0eca9865e90665fd0c1fbf57d0f4a560/games-multiplayer-overlay-detail%402x.png)
...
![A diagram of a multiplayer activity card, with callouts indicating the activity title, artwork, and number of players, and the system-provided gradient at the bottom of the card.](https://docs-assets.developer.apple.com/published/3706a16b6083fbeab19d4ef2624b0061/games-multiplayer-anatomy%402x.png)
...
[![](https://devimages-cdn.apple.com/wwdc-services/images/3055294D-836B-4513-B7B0-0BC5666246B0/0BEC1E9E-5221-48F9-853B-BEDA2BE23D63/9892_wide_250x141_3x.jpg)\\
\\
Get started with Game Center](https://developer.apple.com/videos/play/wwdc2025/214)

[![](https://devimages-cdn.apple.com/wwdc-services/images/3055294D-836B-4513-B7B0-0BC5666246B0/0C96EE37-E8A0-46DB-88B3-3BF6C3F633DD/9893_wide_250x141_3x.jpg)\\
\\
