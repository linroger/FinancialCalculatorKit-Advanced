---
url: "https://developer.apple.com/design/human-interface-guidelines/collaboration-and-sharing?changes=_5"
title: "Collaboration and sharing | Apple Developer Documentation"
---

[Skip Navigation](https://developer.apple.com/design/human-interface-guidelines/collaboration-and-sharing?changes=_5#app-main)
...
In addition to helping people share and collaborate on documents, visionOS supports immersive sharing experiences through SharePlay. For guidance, see [SharePlay](https://developer.apple.com/design/human-interface-guidelines/shareplay?changes=_5).

## [Best practices](https://developer.apple.com/design/human-interface-guidelines/collaboration-and-sharing?changes=_5\#Best-practices)

**Place the Share button in a convenient location, like a toolbar, to make it easy for people to start sharing or collaborating.** In iOS 16, the system-provided share sheet includes ways to choose a file-sharing method and set permissions for a new collaboration; iPadOS 16 and macOS 13 introduce similar appearance and functionality in the sharing popover. In your SwiftUI app, you can also enable sharing by presenting a share link that opens the system-provided share sheet when people choose it; for developer guidance, see [`ShareLink`](https://developer.apple.com/documentation/SwiftUI/ShareLink?changes=_5).

![An illustration a document open on iPhone. The document contents are abstracted, and the document toolbar prominently features the Share button next to the Collaboration button.](https://docs-assets.developer.apple.com/published/e7d6739fd993942d7537bed083a3af80/collaboration-share-button%402x.png)
...
![An illustration of the share sheet on iPhone, with collaboration options set to indicate that only invited people can edit the selected document.](https://docs-assets.developer.apple.com/published/cf8c49f70e0bd6cdb94dc1314cfd6d1b/collaboration-sharing-permission-invited%402x.png)

![An illustration of the share sheet on iPhone, with collaboration options set to indicate that everyone can make changes to the selected document.](https://docs-assets.developer.apple.com/published/19a5adfe76c0bbd855fce41791f97fee/collaboration-sharing-permission-everyone%402x.png)
...
![An illustration of a Notes document open on iPhone. The document contents are abstracted, and the document toolbar prominently features the Collaboration button next to the Share button.](https://docs-assets.developer.apple.com/published/cead43a9183bc53ee4bf31a45f7705bc/collaboration-status-active-collaboration-button%402x.png)
...
![An illustration of a Notes document on iPhone with the document contents abstracted. A menu is open from the Collaboration button in the document toolbar, with buttons to display the most recent updates and activities.](https://docs-assets.developer.apple.com/published/ddfd0b7d335863875bf0369bd8d1398b/collaboration-custom-popover-notes%402x.png)
...
## [Platform considerations](https://developer.apple.com/design/human-interface-guidelines/collaboration-and-sharing?changes=_5\#Platform-considerations)

_No additional considerations for iOS, iPadOS, or macOS. Not available in tvOS._

### [visionOS](https://developer.apple.com/design/human-interface-guidelines/collaboration-and-sharing?changes=_5\#visionOS)

By default, the system supports screen sharing for an app running in the Shared Space by streaming the current window to other collaborators. If one person transitions the app to a Full Space while sharing is in progress, the system pauses the stream for other people until the app returns to the Shared Space. For guidance, see [Immersive experiences](https://developer.apple.com/design/human-interface-guidelines/immersive-experiences?changes=_5).

### [watchOS](https://developer.apple.com/design/human-interface-guidelines/collaboration-and-sharing?changes=_5\#watchOS)

In your SwiftUI app running in watchOS, use [`ShareLink`](https://developer.apple.com/documentation/SwiftUI/ShareLink?changes=_5) to present the system-provided share sheet.

## [Resources](https://developer.apple.com/design/human-interface-guidelines/collaboration-and-sharing?changes=_5\#Resources)

#### [Related](https://developer.apple.com/design/human-interface-guidelines/collaboration-and-sharing?changes=_5\#Related)

[Activity views](https://developer.apple.com/design/human-interface-guidelines/activity-views?changes=_5)

#### [Developer documentation](https://developer.apple.com/design/human-interface-guidelines/collaboration-and-sharing?changes=_5\#Developer-documentation)

[Shared With You](https://developer.apple.com/documentation/SharedWithYou-technology?changes=_5)

[`ShareLink`](https://developer.apple.com/documentation/SwiftUI/ShareLink?changes=_5) — SwiftUI

#### [Videos](https://developer.apple.com/design/human-interface-guidelines/collaboration-and-sharing?changes=_5\#Videos)

[![](https://devimages-cdn.apple.com/wwdc-services/images/124/74342B30-92E9-48F3-B0F2-6E42C8FD9391/6506_wide_250x141_3x.jpg)\\
\\
Design for Collaboration with Messages](https://developer.apple.com/videos/play/wwdc2022/10015)

[![](https://devimages-cdn.apple.com/wwdc-services/images/124/9785075B-13E9-4631-AD74-77B814019BF4/6589_wide_250x141_3x.jpg)\\
\\
Enhance collaboration experiences with Messages](https://developer.apple.com/videos/play/wwdc2022/10095)

[![](https://devimages-cdn.apple.com/wwdc-services/images/124/39FE3E81-AB11-4FEE-AE05-37951E2ADB12/6587_wide_250x141_3x.jpg)\\
\\
Integrate your custom collaboration app with Messages](https://developer.apple.com/videos/play/wwdc2022/10093)

## [Change log](https://developer.apple.com/design/human-interface-guidelines/collaboration-and-sharing?changes=_5\#Change-log)
...
- [Collaboration and sharing](https://developer.apple.com/design/human-interface-guidelines/collaboration-and-sharing?changes=_5#app-top)
- [Best practices](https://developer.apple.com/design/human-interface-guidelines/collaboration-and-sharing?changes=_5#Best-practices)
- [Platform considerations](https://developer.apple.com/design/human-interface-guidelines/collaboration-and-sharing?changes=_5#Platform-considerations)
- [Resources](https://developer.apple.com/design/human-interface-guidelines/collaboration-and-sharing?changes=_5#Resources)
- [Change log](https://developer.apple.com/design/human-interface-guidelines/collaboration-and-sharing?changes=_5#Change-log)