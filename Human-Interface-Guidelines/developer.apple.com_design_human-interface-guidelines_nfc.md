...
[Skip Navigation](https://developer.apple.com/design/human-interface-guidelines/nfc#app-main)
...
![An illustration of a scanning sheet on iPhone, which includes the text Ready to Scan and a Cancel button.](https://docs-assets.developer.apple.com/published/22cb214f35d0a13bc000986686252960/nfc-ready-to-scan%402x.png)
...
![An illustration of a notification banner above the Home screen on iPhone, which offers an opportunity to open a specific app to process NFC tag data detected nearby.](https://docs-assets.developer.apple.com/published/f1373265760014db3509eb3802aaa81a/nfc-background%402x.png)
...
- [NFC](https://developer.apple.com/design/human-interface-guidelines/nfc#app-top)
- [In-app tag reading](https://developer.apple.com/design/human-interface-guidelines/nfc#In-app-tag-reading)
- [Background tag reading](https://developer.apple.com/design/human-interface-guidelines/nfc#Background-tag-reading)
- [Platform considerations](https://developer.apple.com/design/human-interface-guidelines/nfc#Platform-considerations)
- [Resources](https://developer.apple.com/design/human-interface-guidelines/nfc#Resources)