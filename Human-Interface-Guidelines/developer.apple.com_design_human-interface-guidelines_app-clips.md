...
![A screenshot of an iPhone Home screen. The bottom half of the screen shows the App Clip card for a flower shop’s App Clip as it appears when the person invokes the App Clip.](https://docs-assets.developer.apple.com/published/5edd68eab7f4364f92b48a8472e94825/app-clips-hero-1%402x.png)

![A screenshot of a flower shop’s App Clip on iPhone as it appears when a person confirms the App Clip’s launch on the App Clip card. The App Clip displays a grid with various flowers the person can order.](https://docs-assets.developer.apple.com/published/108b9569901652ad9c82aaae80214c20/app-clips-hero-2%402x.png)
...
![An illustration of an App Clip card on a partial iPhone screen, as it appears when someone invokes an App Clip. The bottom of the App Clip card includes an Open button the person can tap to launch the App Clip, and an area the person can tap to display the App Clip’s corresponding app in the App Store.](https://docs-assets.developer.apple.com/published/11c758b8c76ec8e89dab204306bd0172/app-clips-card-focus%402x.png)

![An illustration of a partial iPhone screen. An overlay appears above the bottom of the screen, and someone can tap it to install an App Clip’s corresponding app.](https://docs-assets.developer.apple.com/published/9c9018e84783c242044c46db57e8ac14/app-clips-appstore-focus%402x.png)
...
![An App Clip Code that uses a badge design with the App Clip logo.](https://docs-assets.developer.apple.com/published/ece10c4a3732e439ab897552360158e0/with-appclip-logo%402x.png)App Clip Code with the App Clip logo

![An App Clip Code that uses a design without the App Clip logo.](https://docs-assets.developer.apple.com/published/55246d40033b2a35e3429e100c28b8d8/without-appclip-logo%402x.png)App Clip Code without the App Clip logo
...
![A scan-only App Clip Code with callouts for the center icon, visual code, and the App Clip logo.](https://docs-assets.developer.apple.com/published/10b69c223fe9d1edcdd2eb7018a02a35/scan-only%402x.png)
...
![An App Clip Code that uses the badge design and has a minimum diameter of 3/4 inch (1.9 cm).](https://docs-assets.developer.apple.com/published/af9a9e65960b1d40d6432a16966afcb2/sizing-minimum-rectangle%402x.png)

![An App Clip Code that uses the design without the App Clip logo and has a minimum diameter of 3/4 inch (1.9 cm).](https://docs-assets.developer.apple.com/published/d43320aeea0bc23b2d7ec1567a166674/sizing-minimum-circular%402x.png)
...
![An illustration of an App Clip Code that uses the badge design and has callouts for the background, foreground, and generated colors.](https://docs-assets.developer.apple.com/published/b5e37905ce8a6686a92482e779ac0c5a/app-clip-colors%402x.png)
...
[![](https://devimages-cdn.apple.com/wwdc-services/images/119/95357E8D-01E6-476E-9516-8AF54EC9794A/4878_wide_250x141_3x.jpg)\\
\\
What's new in App Clips](https://developer.apple.com/videos/play/wwdc2021/10012)

[![](https://devimages-cdn.apple.com/wwdc-services/images/119/7120E473-4A84-447D-8B55-0F1614324E59/4879_wide_250x141_3x.jpg)\\
\\
...
- [App Clips](https://developer.apple.com/design/human-interface-guidelines/app-clips#app-top)
- [Designing your App Clip](https://developer.apple.com/design/human-interface-guidelines/app-clips#Designing-your-App-Clip)
- [Creating content for an App Clip card](https://developer.apple.com/design/human-interface-guidelines/app-clips#Creating-content-for-an-App-Clip-card)
- [App Clip Codes](https://developer.apple.com/design/human-interface-guidelines/app-clips#App-Clip-Codes)
- [Printing guidelines](https://developer.apple.com/design/human-interface-guidelines/app-clips#Printing-guidelines)
