---
url: "https://developer.apple.com/design/human-interface-guidelines/charting-data?changes=_5"
title: "Charting data | Apple Developer Documentation"
---

[Skip Navigation](https://developer.apple.com/design/human-interface-guidelines/charting-data?changes=_5#app-main)
...
## [Best practices](https://developer.apple.com/design/human-interface-guidelines/charting-data?changes=_5\#Best-practices)
...
![A screenshot of the Stocks app on iPhone. The app uses a line chart to depict the performance of a stock over the currently chosen five-year period.](https://docs-assets.developer.apple.com/published/c01a545524219a7bc1a571ebba17728a/charts-stocks%402x.png)

![A screenshot of the Activity screen in the Health app on iPhone. The app uses a set of three bar charts to depict information from the three Activity Rings over the currently chosen one-day period.](https://docs-assets.developer.apple.com/published/b5f9c0309579a898cf1b7528d33b65fb/charts-activity%402x.png)
...
## [Platform considerations](https://developer.apple.com/design/human-interface-guidelines/charting-data?changes=_5\#Platform-considerations)

_No additional considerations for iOS, iPadOS, macOS, tvOS, visionOS, or watchOS._

## [Resources](https://developer.apple.com/design/human-interface-guidelines/charting-data?changes=_5\#Resources)

#### [Related](https://developer.apple.com/design/human-interface-guidelines/charting-data?changes=_5\#Related)

[Charts](https://developer.apple.com/design/human-interface-guidelines/charts?changes=_5)

#### [Developer documentation](https://developer.apple.com/design/human-interface-guidelines/charting-data?changes=_5\#Developer-documentation)

[Swift Charts](https://developer.apple.com/documentation/Charts?changes=_5)

#### [Videos](https://developer.apple.com/design/human-interface-guidelines/charting-data?changes=_5\#Videos)
...
## [Change log](https://developer.apple.com/design/human-interface-guidelines/charting-data?changes=_5\#Change-log)
...
- [Charting data](https://developer.apple.com/design/human-interface-guidelines/charting-data?changes=_5#app-top)
- [Best practices](https://developer.apple.com/design/human-interface-guidelines/charting-data?changes=_5#Best-practices)
- [Designing effective charts](https://developer.apple.com/design/human-interface-guidelines/charting-data?changes=_5#Designing-effective-charts)
- [Platform considerations](https://developer.apple.com/design/human-interface-guidelines/charting-data?changes=_5#Platform-considerations)
- [Resources](https://developer.apple.com/design/human-interface-guidelines/charting-data?changes=_5#Resources)
