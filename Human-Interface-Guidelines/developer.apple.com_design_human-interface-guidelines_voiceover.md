...
[Skip Navigation](https://developer.apple.com/design/human-interface-guidelines/voiceover#app-main)
...
![An illustration of the top portion of an iPhone device. The UI onscreen shows two images. One is a basket of mangoes, and the other is a basket of artichokes. There are captions beneath the images that read 'Mangoes come from trees that belong to the genus Mangifera.' and 'Artichokes come from a variety of a species of thistle.' The images and captions are all contained within a single VoiceOver frame.](https://docs-assets.developer.apple.com/published/861eb30b14af842b26e993974ab919f4/voiceover-incorrect-grouping%402x.png)Ungrouped related elements make it hard for VoiceOver to accurately describe the UI.

![An X in a circle to indicate incorrect usage.](https://docs-assets.developer.apple.com/published/209f6f0fc8ad99d9bf59e12d82d06584/crossout%402x.png)

![An illustration of the top portion of an iPhone device. The UI onscreen shows two images. One is a basket of mangoes, and the other is a basket of artichokes. There are captions beneath the images that read 'Mangoes come from trees that belong to the genus Mangifera.' and 'Artichokes come from a variety of a species of thistle.' Just the mangoes image and its caption are contained within a single VoiceOver frame.](https://docs-assets.developer.apple.com/published/9d89364705e7fb579afe50b683338586/voiceover-correct-grouping%402x.png)Grouped related elements help VoiceOver accurately describe the UI.
...
[![](https://devimages-cdn.apple.com/wwdc-services/images/48/23AF104C-7CFE-4F7B-AEC6-46F54121AE92/2966_wide_250x141_3x.jpg)\\
\\
Writing Great Accessibility Labels](https://developer.apple.com/videos/play/wwdc2019/254)

[![](https://devimages-cdn.apple.com/wwdc-services/images/119/1A6C1BBD-8ADD-4B35-896E-7EBAA39B82FC/5019_wide_250x141_3x.jpg)\\
\\
Tailor the VoiceOver experience in your data-rich apps](https://developer.apple.com/videos/play/wwdc2021/10121)

[![](https://devimages-cdn.apple.com/wwdc-services/images/49/669BA7EE-2BAE-4B94-84E7-41D399756313/3471_wide_250x141_3x.jpg)\\
\\
...
- [VoiceOver](https://developer.apple.com/design/human-interface-guidelines/voiceover#app-top)
- [Descriptions](https://developer.apple.com/design/human-interface-guidelines/voiceover#Descriptions)
- [Navigation](https://developer.apple.com/design/human-interface-guidelines/voiceover#Navigation)
- [Platform considerations](https://developer.apple.com/design/human-interface-guidelines/voiceover#Platform-considerations)
- [Resources](https://developer.apple.com/design/human-interface-guidelines/voiceover#Resources)
