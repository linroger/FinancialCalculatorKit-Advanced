...
[Skip Navigation](https://developer.apple.com/design/human-interface-guidelines/path-controls#app-main)
...
![A screenshot of a Finder path bar that displays a hierarchy of four locations.](https://docs-assets.developer.apple.com/published/d942e4e04fc5f2660068fa5657c5e55e/path-controls-standard%402x.png)
...
![A screenshot of a path control showing a folder icon and a pop-up control.](https://docs-assets.developer.apple.com/published/8bad68ea069e9433497176572c24562f/path-controls-popup%402x.png)
...
- [Path controls](https://developer.apple.com/design/human-interface-guidelines/path-controls#app-top)
- [Best practices](https://developer.apple.com/design/human-interface-guidelines/path-controls#Best-practices)
- [Platform considerations](https://developer.apple.com/design/human-interface-guidelines/path-controls#Platform-considerations)
- [Resources](https://developer.apple.com/design/human-interface-guidelines/path-controls#Resources)