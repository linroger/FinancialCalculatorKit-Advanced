...
![An illustration of an inline tip on iPhone. The tip is embedded in the middle of the display, pointing to a feature labeled favorite. Obscured text appears above and below the tip, demonstrating the inline nature of this tip style.](https://docs-assets.developer.apple.com/published/eb6a2cb70089f6b49f25ff588ee03aa1/tips-inline-notification%402x.png)
...
![An illustration of a popover tip on iPhone. The tip is in the middle of the display, pointing to a feature labeled favorite. Obscured text appears behind the tip to illustrate how the popover tip style hides elements beneath it.](https://docs-assets.developer.apple.com/published/0470e36ffc754c276c2852b45eead7b9/tips-popover-notification%402x.png)
...
![A partial screenshot of a menu bar in macOS with the pointer over a sidebar icon. A tooltip with the title Show sidebar appears beneath the pointer.](https://docs-assets.developer.apple.com/published/7318fb63be0bd5fd08a79eeb537671fb/macos-tooltip-help-tag%402x.png)
...
[![](https://devimages-cdn.apple.com/wwdc-services/images/D35E0E85-CCB6-41A1-B227-7995ECD83ED5/7BCB7D16-5D51-419D-B332-E008219FB631/8293_wide_250x141_3x.jpg)\\
\\
