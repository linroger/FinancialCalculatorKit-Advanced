---
url: "https://developer.apple.com/design/human-interface-guidelines/drag-and-drop?changes=_5"
title: "Drag and drop | Apple Developer Documentation"
---

[Skip Navigation](https://developer.apple.com/design/human-interface-guidelines/drag-and-drop?changes=_5#app-main)
...
## [Best practices](https://developer.apple.com/design/human-interface-guidelines/drag-and-drop?changes=_5\#Best-practices)
...
**Offer alternative ways to accomplish drag-and-drop actions.** Sometimes, drag-and-drop operations are inconvenient or impossible for people to perform, so it’s important to provide other ways to do the same things. For example, you can include menu commands that people can use to copy an item and move it to another location. In iOS and iPadOS, you can use accessibility APIs to identify sources and destinations so that people can use assistive technologies to drag and drop in your app (for developer guidance, see [`accessibilityDragSourceDescriptors`](https://developer.apple.com/documentation/ObjectiveC/NSObject-swift.class/accessibilityDragSourceDescriptors?changes=_5) and [`accessibilityDropPointDescriptors`](https://developer.apple.com/documentation/ObjectiveC/NSObject-swift.class/accessibilityDropPointDescriptors?changes=_5)).
...
## [Providing feedback](https://developer.apple.com/design/human-interface-guidelines/drag-and-drop?changes=_5\#Providing-feedback)
...
## [Accepting drops](https://developer.apple.com/design/human-interface-guidelines/drag-and-drop?changes=_5\#Accepting-drops)
...
## [Platform considerations](https://developer.apple.com/design/human-interface-guidelines/drag-and-drop?changes=_5\#Platform-considerations)

_Not supported in tvOS or watchOS._

### [iOS, iPadOS](https://developer.apple.com/design/human-interface-guidelines/drag-and-drop?changes=_5\#iOS-iPadOS)
...
### [macOS](https://developer.apple.com/design/human-interface-guidelines/drag-and-drop?changes=_5\#macOS)
...
### [visionOS](https://developer.apple.com/design/human-interface-guidelines/drag-and-drop?changes=_5\#visionOS)

**When possible, launch your app to handle content that people drop into empty space.** When you associate a user activity with draggable app content, your app can open a window or scene that handles the content when people drop it. For example, when people drop a URL into empty space, it launches Safari; when people drop Quick Look–supported content, Quick Look launches to display it. For developer guidance, see [`NSUserActivity`](https://developer.apple.com/documentation/Foundation/NSUserActivity?changes=_5).
...
[Play](https://developer.apple.com/design/human-interface-guidelines/drag-and-drop?changes=_5#)

## [Resources](https://developer.apple.com/design/human-interface-guidelines/drag-and-drop?changes=_5\#Resources)

#### [Related](https://developer.apple.com/design/human-interface-guidelines/drag-and-drop?changes=_5\#Related)

[Universal Control](https://support.apple.com/en-us/HT212757)

#### [Developer documentation](https://developer.apple.com/design/human-interface-guidelines/drag-and-drop?changes=_5\#Developer-documentation)

[Drag and drop](https://developer.apple.com/documentation/UIKit/drag-and-drop?changes=_5) — UIKit

[Drag and Drop](https://developer.apple.com/documentation/AppKit/drag-and-drop?changes=_5) — AppKit

[File Provider](https://developer.apple.com/documentation/FileProvider?changes=_5)

#### [Videos](https://developer.apple.com/design/human-interface-guidelines/drag-and-drop?changes=_5\#Videos)

[![](https://devimages-cdn.apple.com/wwdc-services/images/119/9CCE8A5D-A751-441C-B88F-FB91E2D1958E/4949_wide_250x141_3x.jpg)\\
\\
What's new in UIKit](https://developer.apple.com/videos/play/wwdc2021/10059)

[![](https://devimages-cdn.apple.com/wwdc-services/images/119/F93E642C-EBBD-479E-AC7F-F801103EF53F/5227_wide_250x141_3x.jpg)\\
\\
SwiftUI on the Mac: The finishing touches](https://developer.apple.com/videos/play/wwdc2021/10289)

[![](https://devimages-cdn.apple.com/wwdc-services/images/49/5C8F0205-3AE9-4647-870B-5C10FB7EA6FF/3520_wide_250x141_3x.jpg)\\
\\
Designed for iPad](https://developer.apple.com/videos/play/wwdc2020/10206)

## [Change log](https://developer.apple.com/design/human-interface-guidelines/drag-and-drop?changes=_5\#Change-log)
...
- [Drag and drop](https://developer.apple.com/design/human-interface-guidelines/drag-and-drop?changes=_5#app-top)
- [Best practices](https://developer.apple.com/design/human-interface-guidelines/drag-and-drop?changes=_5#Best-practices)
- [Providing feedback](https://developer.apple.com/design/human-interface-guidelines/drag-and-drop?changes=_5#Providing-feedback)
- [Accepting drops](https://developer.apple.com/design/human-interface-guidelines/drag-and-drop?changes=_5#Accepting-drops)
- [Platform considerations](https://developer.apple.com/design/human-interface-guidelines/drag-and-drop?changes=_5#Platform-considerations)
