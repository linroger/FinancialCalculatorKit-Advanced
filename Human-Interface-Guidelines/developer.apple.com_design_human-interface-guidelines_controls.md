...
Control buttons perform an action, link to a specific area of your app, or launch a [camera experience on a locked device](https://developer.apple.com/design/human-interface-guidelines/controls#Camera-experiences-on-a-locked-device). Control toggles switch between two states, such as on and off.
...
![A diagram showing the placement of the symbol image, the title, and the value for a control toggle that turns a floor lamp on and off.](https://docs-assets.developer.apple.com/published/e198c267baadf7d7c91707725362c725/control-medium-anatomy%402x.png)
...
![An inactive control toggle with a lightbulb symbol that isn't tinted.](https://docs-assets.developer.apple.com/published/7b0fdb842a40d4910d18f0f12d0525ba/control-lightbulb-not-tinted%402x.png)Nontinted control toggle in the off state

![An active control toggle with a lightbulb.max symbol that's tinted yellow.](https://docs-assets.developer.apple.com/published/fc1bf584b13485bdca5137c4bd5d8811/control-lightbulb-tinted%402x.png)Tinted control toggle in the on state
...
![A representation of the configuration of a control that displays a label of the action, the app name, and app icon, as well as the ability to set an option to a value a person chooses.](https://docs-assets.developer.apple.com/published/ab7c549ed35b50ef05490e3bde1bd1d4/control-configuration-options%402x.png)
...
![A partial screenshot of the Home Screen on iPhone that displays hint text for the Action button. The hint text is Hold for Silent.](https://docs-assets.developer.apple.com/published/022a6465a8470db6811ffc1dceb71809/controls-action-button-coaching-text-on%402x.png)

![A partial screenshot of the Home Screen on iPhone that displays hint text for the Action button. The hint text is Hold for Ring.](https://docs-assets.developer.apple.com/published/403dd277a6625a3a42a8a20b0e3a894a/controls-action-button-coaching-text-off%402x.png)
...
![A medium-sized control toggle displaying a symbol of a lightbulb, a title that displays Floor Lamp, and value text that displays on.](https://docs-assets.developer.apple.com/published/ad3243c6de1a3f2b13d525fb0c28bcfb/control-regular-text%402x.png)Control toggle with no information hidden

![A medium-sized control toggle that has a redacted symbol and redacted text.](https://docs-assets.developer.apple.com/published/1ea99e16e22c0a3445659bb7e7f4348b/control-redacted-text%402x.png)Control toggle with information hidden on a locked device
