---
url: "https://developer.apple.com/design/human-interface-guidelines/going-full-screen?changes=_5"
title: "Going full screen | Apple Developer Documentation"
---

[Skip Navigation](https://developer.apple.com/design/human-interface-guidelines/going-full-screen?changes=_5#app-main)
...
## [Resources](https://developer.apple.com/design/human-interface-guidelines/going-full-screen?changes=_5\#Resources)

#### [Related](https://developer.apple.com/design/human-interface-guidelines/going-full-screen?changes=_5\#Related)
...
[Windows](https://developer.apple.com/design/human-interface-guidelines/windows?changes=_5)

[The menu bar](https://developer.apple.com/design/human-interface-guidelines/the-menu-bar?changes=_5)

#### [Developer documentation](https://developer.apple.com/design/human-interface-guidelines/going-full-screen?changes=_5\#Developer-documentation)

[`fullScreenCover(item:onDismiss:content:)`](https://developer.apple.com/documentation/SwiftUI/View/fullScreenCover(item:onDismiss:content:)?changes=_5) — SwiftUI

[`NSScreen`](https://developer.apple.com/documentation/AppKit/NSScreen?changes=_5) — AppKit

[`NSWindow.CollectionBehavior`](https://developer.apple.com/documentation/AppKit/NSWindow/CollectionBehavior-swift.struct?changes=_5) — AppKit

#### [Videos](https://developer.apple.com/design/human-interface-guidelines/going-full-screen?changes=_5\#Videos)
...
## [Change log](https://developer.apple.com/design/human-interface-guidelines/going-full-screen?changes=_5\#Change-log)
...
- [Going full screen](https://developer.apple.com/design/human-interface-guidelines/going-full-screen?changes=_5#app-top)
- [Best practices](https://developer.apple.com/design/human-interface-guidelines/going-full-screen?changes=_5#Best-practices)
- [Platform considerations](https://developer.apple.com/design/human-interface-guidelines/going-full-screen?changes=_5#Platform-considerations)
- [Resources](https://developer.apple.com/design/human-interface-guidelines/going-full-screen?changes=_5#Resources)
- [Change log](https://developer.apple.com/design/human-interface-guidelines/going-full-screen?changes=_5#Change-log)