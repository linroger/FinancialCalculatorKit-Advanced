---
url: "https://developer.apple.com/design/human-interface-guidelines/dark-mode?changes=_5"
title: "Dark Mode | Apple Developer Documentation"
---

[Skip Navigation](https://developer.apple.com/design/human-interface-guidelines/dark-mode?changes=_5#app-main)
...
## [Best practices](https://developer.apple.com/design/human-interface-guidelines/dark-mode?changes=_5\#Best-practices)
...
![A screenshot of the Stocks app on iPhone in its standard dark-only appearance, showing the Apple Inc. stock in detail. The view includes a summary of the current stock price along with a graph of its performance over the past year.](https://docs-assets.developer.apple.com/published/4086cb4a337e5958289f82cddae3fabd/dark-mode-stocks-app-dark-only-mode%402x.png)

The Stocks app uses a dark-only appearance

## [Dark Mode colors](https://developer.apple.com/design/human-interface-guidelines/dark-mode?changes=_5\#Dark-Mode-colors)

The color palette in Dark Mode includes dimmer background colors and brighter foreground colors. It’s important to realize that these colors aren’t necessarily inversions of their light counterparts: while many colors are inverted, some are not. For more information, see [Specifications](https://developer.apple.com/design/human-interface-guidelines/color?changes=_5#Specifications).

**Embrace colors that adapt to the current appearance.** Semantic colors (like [`labelColor`](https://developer.apple.com/documentation/AppKit/NSColor/labelColor?changes=_5) and [`controlColor`](https://developer.apple.com/documentation/AppKit/NSColor/controlColor?changes=_5) in macOS or [`separator`](https://developer.apple.com/documentation/UIKit/UIColor/separator?changes=_5) in iOS and iPadOS) automatically adapt to the current appearance. When you need a custom color, add a Color Set asset to your app’s asset catalog in Xcode, and specify the bright and dim variants of the color. Avoid using hard-coded color values or colors that don’t adapt.
...
### [Icons and images](https://developer.apple.com/design/human-interface-guidelines/dark-mode?changes=_5\#Icons-and-images)

The system uses [SF Symbols](https://developer.apple.com/design/human-interface-guidelines/sf-symbols?changes=_5) (which automatically adapt to Dark Mode) and full-color images that are optimized for both the light and dark appearances.

**Use SF Symbols wherever possible.** Symbols work well in both appearance modes when you use dynamic colors to tint them or when you add vibrancy. For guidance, see [Color](https://developer.apple.com/design/human-interface-guidelines/color?changes=_5).
...
### [Text](https://developer.apple.com/design/human-interface-guidelines/dark-mode?changes=_5\#Text)
...
## [Platform considerations](https://developer.apple.com/design/human-interface-guidelines/dark-mode?changes=_5\#Platform-considerations)

_No additional considerations for tvOS. Dark Mode isn’t supported in visionOS or watchOS._

### [iOS, iPadOS](https://developer.apple.com/design/human-interface-guidelines/dark-mode?changes=_5\#iOS-iPadOS)
...
### [macOS](https://developer.apple.com/design/human-interface-guidelines/dark-mode?changes=_5\#macOS)
...
## [Resources](https://developer.apple.com/design/human-interface-guidelines/dark-mode?changes=_5\#Resources)

#### [Related](https://developer.apple.com/design/human-interface-guidelines/dark-mode?changes=_5\#Related)
...
#### [Videos](https://developer.apple.com/design/human-interface-guidelines/dark-mode?changes=_5\#Videos)
...
[![](https://devimages-cdn.apple.com/wwdc-services/images/48/174747D6-8723-4194-A932-7765179F1108/2949_wide_250x141_3x.jpg)\\
\\
Implementing Dark Mode on iOS](https://developer.apple.com/videos/play/wwdc2019/214)

## [Change log](https://developer.apple.com/design/human-interface-guidelines/dark-mode?changes=_5\#Change-log)
...
- [Dark Mode](https://developer.apple.com/design/human-interface-guidelines/dark-mode?changes=_5#app-top)
- [Best practices](https://developer.apple.com/design/human-interface-guidelines/dark-mode?changes=_5#Best-practices)
- [Dark Mode colors](https://developer.apple.com/design/human-interface-guidelines/dark-mode?changes=_5#Dark-Mode-colors)
- [Platform considerations](https://developer.apple.com/design/human-interface-guidelines/dark-mode?changes=_5#Platform-considerations)
- [Resources](https://developer.apple.com/design/human-interface-guidelines/dark-mode?changes=_5#Resources)
